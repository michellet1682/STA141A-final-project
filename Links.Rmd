...
This is the function for calculating the optimal k to use. Due to the long computing time (about 5 hours thanks to Connor), there will be no output shown here. The computed optimal is k = 3.
