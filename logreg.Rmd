...
plot(roc, main = "ROC Curve", print.cutoffs.at = seq(0.1, 0.9, 0.1), colorize = T, lwd = 2)
```
...
threshold
```
The AUC is 0.834 which is quite good since it's closer to 1 than 0.5. The calculated threshold is 0.083 which aligns with the ROC curve from above. 
